...
info "required files"
for file in docker-compose.lite.yml .env.example ops/common.sh ops/start-core.sh ops/healthcheck.sh ops/backup-db.sh ops/test-event-ingest.sh ops/retry-dlq.sh ops/event-stats.sh ops/test-event-stats.sh; do
